function r = ChiSquaredRandom(v,m,n);
...
if nargin == 1
    [errorcode rows columns] = RandomCheck(1,1,v);
end

if nargin == 2
    [errorcode rows columns] = RandomCheck(2,1,v,m);
end

if nargin == 3
    [errorcode rows columns] = RandomCheck(3,1,v,m,n);
end
...
r = GammaRandomDraw(v ./ 2,2,rows,columns);

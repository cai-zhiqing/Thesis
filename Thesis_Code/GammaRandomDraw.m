function r = GammaRandomDraw(a,b,m,n);
...
if nargin == 2
    [errorcode rows columns] = RandomCheck(2,2,a,b);
end

if nargin == 3
    [errorcode rows columns] = RandomCheck(3,2,a,b,m);
end

if nargin == 4
    [errorcode rows columns] = RandomCheck(4,2,a,b,m,n);
end
